                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6 docs">
                            <h3 class="changePostion step-two">Mnotify Docs</h3>
                            <p>Mnotify is a platform for sending SMS . This service leverages on the platform to send out SMSs.
                            <h3 class="">Getting Started With Gmailer</h3> 
                            <p>
                                Follow the following steps to integrate Mnotify into your DevLess app . 
                                <ul>
